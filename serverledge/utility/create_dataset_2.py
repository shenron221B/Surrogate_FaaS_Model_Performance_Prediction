...
def main():
    if len(sys.argv) < 3:
        ...
        print("Uso: python3 create_dataset_2.py <Dir> <Num_Funcs>")
        sys.exit(1)
    ...
    Queue_matrix, Init_matrix, NetOv_matrix = [], [], []
    ...
    for idx_row, row in enumerate(rows):
        ...
        for f in range(FUNC_OFFSET, FUNC_OFFSET + FUNCTIONS):
            ...
            _, mean_dur, mean_init, mean_queue, cold_count, warm_count = read_http_file_extended(file_txt)
