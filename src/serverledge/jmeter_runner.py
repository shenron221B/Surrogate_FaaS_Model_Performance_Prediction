...
# aggiunta 'utils' al sys.path per importare load_matrix
sys.path.append(str(BASE_DIR / "utils"))
try:
    from load_matrix import MATRICES
except ImportError:
    print("[ERRORE] File 'load_matrix.py' non trovato in utils/.")
    sys.exit(1)
...
def print_usage():
    ...
    print("\n Esempio 1F:")
    print("   python3 jmeter_runner.py 1 weather_short /path/weather.jmx /output/1f")
    print(" Esempio 4F:")
    print("   python3 jmeter_runner.py 4 matrix_4f_high /path/4f_test.jmx /output/4f\n")
    sys.exit(1)
