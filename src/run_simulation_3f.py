...
def print_usage():
    print("Uso corretto: python3 run_simulation_3f.py <dir_configurazione> <max_req> <num_scenari>")
    print(
        "Esempio: python3 run_simulation_3f.py /root/tesi_project/serverledge/results/3f_3GBpm/q_len_10/del/x17 30.0 10000")
    sys.exit(1)
