...
def print_usage():
    print("Uso corretto: python3 run_simulation_1f.py <dir_configurazione> <max_req> <num_scenari>")
    print("Esempio: python3 run_simulation_1f.py /root/tesi_project/serverledge/results/1f_2GBpm/del/x10 120.0 10000")
    sys.exit(1)
...
def main():
    ...
    try:
        ...
        print("Errore: max_req deve essere float (es. 120.0) e num_scenari intero (es. 10000).")
        sys.exit(1)
